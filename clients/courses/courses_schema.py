...
class CreateCourseRequestSchema(BaseModel):
    ...
    preview_file_id: str = Field(alias="previewFileId", default_factory=fake.uuid4) #Для негативного теста
    created_by_user_id: str = Field(alias="createdByUserId", default_factory=fake.uuid4)    #Для негативного теста
