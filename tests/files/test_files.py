...
class TestFiles:
    ...
    def test_get_file(self, files_client: FilesClient, function_file: FileFixture):
        response = files_client.get_files(function_file.response.file.id)
    ...
    def test_delete_file(self, files_client: FilesClient, function_file: FileFixture):
        ...
        get_response = files_client.get_files(function_file.response.file.id)
    ...
    def test_get_file_with_incorrect_file_id(self, files_client: FilesClient, function_file: FileFixture):
        response = files_client.get_files("incorrect-file-id")
        response_data = ValidationErrorResponseSchema.model_validate_json(response.text)
